...
from my_app.utils.check_simulyator import check_exam
...
class CheckSimulyatorAPIView(APIView): #PROBLEM: if user send id that is not include for question it also send false
    permission_classes = [IsAuthenticated]
