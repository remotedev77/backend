...
class UserDocumentPagination(PageNumberPagination):
    
    # page_size = 10  # Set your desired page size
    page_size_query_param = 'maxResultCount'  # Define the query parameter to allow clients to specify the page size
    page_query_param = 'skipCount'  # Define the query parameter for specifying the current page
    last_page_strings = ('last',)  # Optionally, you can customize the query parameter used to request the last page
